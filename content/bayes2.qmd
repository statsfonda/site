...
soit la loi $\mathrm{Beta}(a+s, b+n-s)$, où $s = \sum x_i$. L'estimateur de Bayes (MMSE) est  
$$\hat{\theta}_{\mathrm{Bayes}} = \frac{a + s}{a+b+n}.$$
...
et on reconnaît la loi $\Gamma(\alpha + s, \beta + n)$. L'estimateur de Bayes est 
$$\hat{\lambda}_{\mathrm{Bayes}} = \frac{\alpha + s}{\beta + n}.$$
