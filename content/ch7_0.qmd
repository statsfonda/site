...
Soit $(X_{(1)}, \dotsc, X_{(n)})$ l'échantillon trié en ordre croissant. Par convention, on pose $X_{(0)} = -\infty$. La quantité $|F_n - F|_\infty$ est calculable grâce à la représentation suivante : 
