...
### Inégalité de Bienaymé-Tchebychev {.unnumbered}
...
### Inégalité de Hoeffding {.unnumbered}
...
## Intervalles de confiance non-gaussiens {#sec-icber}
...
### Estimation du paramètre $p$ dans un modèle de Bernoulli. {.unnumbered}
...
### Estimation de moyenne dans un modèle non-gaussien. {.unnumbered}
