...
![Une petite gaussienne autour de 1.5 est transformée par une fonction $f \in \mathscr{C}^1$ en une petite gaussienne autour de $f(1.8)$, de variance normalisée par $f'(1.5)$. ](/images/histogram.png){width=60%}

:::

::: {.content-visible when-format="html"} 

![Une petite gaussienne autour de 1.5 est transformée par une fonction $f \in \mathscr{C}^1$ en une petite gaussienne autour de $f(1.8)$, de variance normalisée par $f'(1.5)$. ](/images/histogram.webp)
